...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-header">Bug Tracking System</a>
        </div>
            ...
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu">
					...
					<li><a href="#">Administration</a>
						<ul>
						  <li><a href="project.php">Add New Project</a></li>
						  <li><a href="bug.php">Add New Bug</a></li>
						  <li><a href="user.php">Add User</a></li>
						</ul>
					</li>
					<li><a href="#">Reports</a>
						<ul>
						  <li><a href="project-report.php">Project Reports</a></li>
						  <li><a href="bug-report.php">Bug Reports</a></li>
